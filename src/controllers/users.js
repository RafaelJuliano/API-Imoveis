 ...
 * @param {*} request - {name: String com nome do usuário, cpf: String com o CPF no formato 000.000.000-00, email: String com e-mail valido, pwd: String com senha.}
 ...
 * @param {*} request - {email: String com e-mail valido,  pwd: String com senha}
